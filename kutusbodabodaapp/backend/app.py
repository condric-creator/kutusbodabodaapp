...
# Fixed: Absolute path logic ensures Vercel finds the DB file in the backend folder
...
KUTUS_LOCATIONS = {
    ...
    "ICON": (-0.5568, 33.3333), "RAHA": (-0.5602, 37.3398),
...
def send_request():
    ...
    if token:
        ...
        stk_payload = {
            ...
            "CallBackURL": "https://kutusbodabodaapp.vercel.app/api", 
