...
import random
import math
import os  # Added for environment variables and paths
...
# Essential for Vercel: This allows the 'app' to be imported by the platform
app.debug = True 
...
def home():
    return jsonify({
        "status": "Success", 
        "message": "Kutus Boda Backend is LIVE!",
...
# Fix for deployment: Use a path that is writable or consistent
basedir = os.path.abspath(os.path.dirname(__file__))
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(basedir, 'kutus_boda_v6.db')
...
CONSUMER_KEY = os.environ.get("MPESA_KEY", "Cg4GtJjtJDDvjsO6Fts4A1do7sx91rWMGyu5ktxl5YoxSWEx")
CONSUMER_SECRET = os.environ.get("MPESA_SECRET", "T4PiebXPp8sRbsOumXR5PcPz4t6utH8kYXCUQcNOlWk7AOo7Xfyegb59WMGccdWf")
